...
function updateCookies(){
    ...
    necessaryElements.push(`
        ...
        <div class="cookie-learn-more-wrapper">
            <span class="cookie-learn-more"><a target="_blank" href="${necessaryCookies[platform][0].privacy_rights_portals}">Learn More about the provider</a></span>
    ...
    for (const platform in preferencesCookies) {
        ...
        <div class="cookies">
            ...
            <div class="cookie-learn-more-wrapper">
            <span class="cookie-learn-more"><a href="${preferencesCookies[platform][0].privacy_rights_portals}" target="_blank">Learn More about the provider</a></span>
            <img src="https://cdn-icons-png.flaticon.com/512/54/54345.png" width="20px">
            </div>
        `);
    ...
    for (const platform in analyticsCookies) {
        ...
        <div class="cookies">
            ...
            <div class="cookie-learn-more-wrapper">
            <span class="cookie-learn-more"><a href="${analyticsCookies[platform][0].privacy_rights_portals}" target="_blank">Learn More about the provider</a></span>
            <img src="https://cdn-icons-png.flaticon.com/512/54/54345.png" width="20px">
            </div>
        `);
    ...
    for (const platform in marketingCookies) {
        ...
        <div class="cookies">
            ...
            <div class="cookie-learn-more-wrapper">
            <span class="cookie-learn-more"><a href="${marketingCookies[platform][0].privacy_rights_portals}" target="_blank">Learn More about the provider</a></span>
            <img src="https://cdn-icons-png.flaticon.com/512/54/54345.png" width="20px">
            </div>
        `);
